...
GOLD_TERMS_DATASET_FILE_PATH='/home/ikaraman/Desktop/tubaDictionary/ComputerScience.txt'
SENTENCES_DATASET='/archive/EnglishSentencesDataset/ComputerScience.txt'
FIELD_NAME='computer'
...
### TODO EPOCH
history = model.fit(padded_docs, numpy.array(padded_tags), batch_size=100, epochs=1, validation_split=0.1, verbose=1,
                    callbacks=callbacks)
print("Model created.")
...
with open('/home/ikaraman/Desktop/ExtractedTermsWithLSTM/'+FIELD_NAME+'Terms.txt', 'w') as outputFile:
